export interface ColorScheme {
  ...
  emerald: string; emeraldBg: string; red: string; redBg: string;
  cyan: string; sky: string; violet: string; amber: string; orange: string;
  trackBg: string;
...
export const LIGHT: ColorScheme = {
  bg: '#fafafa', cardBg: 'rgba(255,255,255,0.9)', border: 'rgba(228,228,231,0.8)',
  textPrimary: '#18181b', textSecondary: '#52525b', textMuted: '#a1a1aa', textDim: '#d4d4d8',
  emerald: '#059669', emeraldBg: 'rgba(5,150,105,0.1)',
  red: '#dc2626', redBg: 'rgba(220,38,38,0.1)',
  cyan: '#0891b2', sky: '#0284c7', violet: '#7c3aed', amber: '#d97706', orange: '#ea580c',
  trackBg: '#e4e4e7',
