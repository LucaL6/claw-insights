...
export type EventDensityQuery = { eventDensity: Array<{ hour: number, count: number, hasError: boolean, hasWarning: boolean, hasRestart: boolean, epochStart: number }> };
...
export type MetricsQuery = { metrics: { date: string, range: MetricsRange, bucketMinutes: number, timezone: string, totalTokensK: number, rangeTokensK: number, totalErrors: number, totalWarnings: number, uptimePercent: number, warnings: Array<string>, buckets: Array<{ bucket: number, label: string, epochStart: number, sessions: number, tokensK: number, apiCalls: number, toolCalls: number, errors: number, warnings: number, gatewayUp: boolean, restartEvent: boolean, tokensByModel: Array<{ model: string, tokensK: number }> }> } };
